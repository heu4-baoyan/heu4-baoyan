...
&nbsp;&nbsp;&nbsp;&nbsp;- [SpikingBrain Technical Report: Spiking Brain-inspired Large Models](https://github.com/BICLab/SpikingBrain-7B)（第六作者，Github 1k stars，Transactions on Machine Learning Research）<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;- 中科院自动化所&沐曦科技 类脑大模型（瞬息1.0）：<br>
主要负责vllm推理框架部署工作，在国产GPU上适配分布式系统并构建支持大规模交互的网站。参与架构、算子适配、测评、rebuttal的部分工作，并参与撰写技术报告。<br>
...
我联系的算比较晚，3月份才联系，基本上没几个老师有名额了，但在非常机缘巧合的机会下拿到了口头offer（老师的方向和我本科方向非常match+有相似的履历），后一切走流程（机试+各课题组面试）拿到offer（但机试不能挂0，越多越好，每年会有一到两道简单的语法题）。本以为被养鱼，没成想最后真给我留了坑位。但最终考虑到方向、组内氛围、资源等等因素，忍痛放弃<br>

**2.中国科学院大学前沿交叉科学学院&自动化研究所：**

参加的是国科大叉院的第一届夏令营（第三届招生），第一届和第二届是从自所和计所直博推免中抽一部分人挪到叉院学籍+国科大内部二次选拔所组成的，性质有点类似国科大未来技术学院、人工智能学院，老师们也普遍认为叉院只是给他们增加博士名额的一个手段。只有博士培养，允许在整个中科院体系里选导师（只要双方都同意即可），每年补助10w+（国家+叉院+所，三部分工资），允许自由选择毕业专业，且理论上允许提前博士毕业（所谓的超常规培养，普博允许三年毕业，直博允许四年毕业）。后续如果双选自所的导师，是国科大毕业证+叉院自所双章（虽然还没毕业生，但是院长多次承诺），跟自所是联培性质。

叉院今年的夏令营只招直博生，今年招400个人（本来只开夏令营，鸽子太多又开了预推免，但大部分名额都在夏令营期间招满），分人工智能、集成电路、量子科技、生物制造四个方向，入营难度不一样，笔试的考查内容也不一样（但都有数学），面试考核会根据意愿（实则是根据bg）分配到各个所里（不同所学生水平差距很大，比如分到去自所考核的普遍是清北+华五本科，我被分到空天院考核，我们这边就是以中九为主，少量华五和211 ，但都是根据固定的比例给优营，所以建议填意向表的时候填弱所）

各个所会按照自己夏令营/预推免方式来考核发offer（发的是交叉学院的offer），像空天院就是跟冬令营考核方式一样：一轮专业面试（含项目拷打+英语+专业课+数学抽题），一轮综合群面（一次进去三个人，挨个介绍自己的个人情况、家庭情况、未来规划）。

交叉学院的优势在于可以在整个科学院体系内各研究所选导师，包括比较火热的自动化所和计算所，住宿单人间且补助高。但较坑的点是：先入学后双选导师，博士入学前不确定自己的导师是谁还是件挺恐怖的事情。我的情况比较特殊，本来不知道有交叉学院这个东西，但是我在自动化所实习的导师给我打电话，让我报名叉院夏令营，所以早早就预定好了名额，后续我也跟他口头、书面多次确认名额一定给我，我也非常信任他+国内基本只有在他这里才能做到我想做的东西，最后才签了交叉学院这边的offer确认书。

往年每个能在交叉学院招生的自所老师（要求承担国家重大项目，以杰青优青为主）有三个名额，今年开始每个自所老师只能在交叉学院招一个名额（这点一定要确认清楚，由于叉院行政比较混乱，有些导师自己不清楚这事）
...
只有博士培养，直博和普博一起竞争入营和录取。大模型中心和具身中心是最难的，直博普遍是清北华五本或者C9前3%+顶会发表，我是大模型中心唯一一个误闯天家的211，事后跟中心里的老师聊：他们说我是为数不多认真回答报名网站上的问题的，比如“有哪些圈内人普遍认可，但你认为有问题的事情，说出你的理由”“你现在做的科研探索有没有了解是否被工业界实践过？效果如何？”这些问题我确实在自所实习过程中思考并探索过很多，大模型现在更像是个偏工程的东西，有很多细节自己没做过是完全想象不到的，很幸运被ai lab老师看到了这些细节。并且我在自所做的工作也是大模型中心正在探索的方向，比较认可我的工程能力和表达能力。

笔试和机试合在了一起，笔试就是考数学三本书+408专业课（不过都比较简单，简单过一下王道计算机考研就够了），机试就是力扣hot 100的难度。面试是各中心的老师混在一起面，面试问的非常细且很考察insight，中英文混合问。最后根据bg和考核分数决定联培学校，但也要再次通过联培学校的考核。感觉今年由于创智学院、中关村学院、河套学院等一系列国家实验室的招生，ai lab的招生被分散出去了，所以难度比起往年有所下降。

住的特别好，吃的也很好。

**4.南京大学智能科学学院：**

这个主要是因为我导师在南大智科也有名额，他怕我自所不稳就让我也报了南大（自所有几个老师在南大智科有直博名额，以谭院士的小导为主），但接到入营的时候我已经拿到叉院的offer了，所以放弃了入营。
...
tele ai今年第二届招收联培直博生，和清华计算机、自动化、电子都有联培，和北大软微也有联培，不同的报名组别和不同的高校课题组合作。首先报名tele ai这边的官网，会有几轮hr来联系和考核（参考各大厂的面试流程），后续也有tele ai的技术老师来考核，根据考核情况来确定联培高校。因为刚开始招生所以了解的人较少，竞争难度并不算大，但后面的坑也不可预知。后续通知的时候我已经跟自所老师确认好，于是放弃。tele ai这边整体的资源确实不错，李学龙老师组建的电信AI研究院，推荐大家多多关注。我报名的是语音大模型组，和清华、上交、西工大若干强组合作很多<br>

**8.清华大学电子工程系某组：**

二月底开始联系，跟导师断断续续联系了几个月，给offer的时候我已经跟自所老师确认好，而且给的是在西交联培的学籍，于是放弃。<br>

**9.清华大学自动化系某组：**

要求提前线上实习几个月，四月份开始打工，六月底去清华线下面试。会根据bg和考核情况分配到清华AI、清华自动化、清华心理、清华生物、复旦的学籍，整体情况较复杂，遂无后续。<br>

**10.南京大学物理学院声学系某组：**

需要线上几轮考核，难度不算大。四月份做完第一轮考核（读几篇论文+复现工作并写成周报）后就线下去找老师聊了一趟（确实觉得非常心怡，各方面都满足我的需求）老师直接给了offer，没再参加后续的考核。老师是特别好的老师，组是特别好的组，保研不一定非要盯着直接对口的学院报（视需而定）。最后在我心中决赛圈甚至是自所>南大声学>北大智能的。<br>
...
在AI领域，基础能力基本就三项：扎实的代码实现能力、数学基础、英语读写能力（听说能力也很重要，但重要性远小于读写）。做到以上三点，即使没有很好的科研产出或者经历，一样也会被老师看重：即使是0领域基础，有强悍的基础能力可以迅速上手，且效率高于有领域基础但基础能力不扎实的同学。这也是很多做AI的老师也会很喜欢数学、物理出身的同学的原因：但ta们仍然需要有较好的编程能力。
